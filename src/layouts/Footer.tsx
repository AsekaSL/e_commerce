...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-[#101922] border-t border-gray-200 dark:border-gray-800 pt-16 pb-8 transition-colors">
        ...
        <p className="text-xs text-gray-400">© 2024 PremiumShop. All rights reserved.</p>
        <div className="flex items-center gap-6">
        <a className="text-gray-400 hover:text-[#1173d4] transition-colors" href="#"><span className="material-symbols-outlined !text-xl">public</span></a>
        <a className="text-gray-400 hover:text-[#1173d4] transition-colors" href="#"><span className="material-symbols-outlined !text-xl">chat</span></a>
        <a className="text-gray-400 hover:text-[#1173d4] transition-colors" href="#"><span className="material-symbols-outlined !text-xl">share</span></a>
        </div>
        </div>
        </div>
    </footer>
