  ...
  return (
    <>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <span className="text-slate-300 dark:text-slate-600 material-symbols-outlined">chevron_right</span>
            ...
            <div>
            <h3 className="text-slate-900 dark:text-white font-bold mb-4 flex items-center gap-2">
            <span className="material-symbols-outlined">payments</span> Price Range
                                </h3>
            ...
            <div>
            <h3 className="text-slate-900 dark:text-white font-bold mb-4 flex items-center gap-2">
            <span className="material-symbols-outlined">star</span> Customer Rating
                                </h3>
            <div className="space-y-2">
            ...
            <span className="material-symbols-outlined fill-1 text-xs">star</span>
            <span className="material-symbols-outlined fill-1 text-xs">star</span>
            <span className="material-symbols-outlined fill-1 text-xs">star_half</span>
            </div>
