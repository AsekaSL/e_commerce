      ...
      <div className="relative aspect-4/5 bg-gray-100 dark:bg-gray-900 overflow-hidden">
        ...
        {product.isFavorite && (
          <div className="absolute top-3 right-3 z-10">
            <button 
              ...
              className="w-8 h-8 bg-white/80 dark:bg-black/40 backdrop-blur-md rounded-full flex items-center justify-center text-gray-700 dark:text-gray-200 hover:text-red-500 transition-colors"
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
          <div onClick={handleAddToCart}>
            <Button 
              styleType="add-to-cart" 
              title="Add to Cart" 
              icon={IconGet("MdAddShoppingCart", "text-xl!")} 
              iconPlace="left" 
            />
          </div>
        </div>
      ...
      <div className="p-4 flex flex-col grow">
        ...
        <div className="mt-auto flex items-center justify-between">
          ...
          <div className="flex items-center text-yellow-400">
            ...
            <span className="text-gray-600 dark:text-gray-400 text-xs font-semibold ml-1">
...
const TrendingNow = memo(() => {
  // Memoize the slice of products to avoid recalculation
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-2">
          <button 
            ...
            className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-gray-800 transition-colors"
